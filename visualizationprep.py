...
if __name__ == '__main__':
    ...
    # Manually list available layouts that are default with Cytoscape, plus 
    # the ones implemented herein. Cannot pull a live list of layouts from
    # Cytoscape given the constraint of not having Cytoscape open before 
    # running the script.
    availableLayouts = ['attribute-circle',
                        'stacked-node-layout',
                        'degree-circle',
                        'circular',
                        'attributes-layout',
